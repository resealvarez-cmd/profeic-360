          ...
          <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-3">
                      <select 
                          className="flex-1 h-11 text-sm font-bold text-slate-900 bg-white border border-slate-200 rounded-lg px-4 focus:outline-none focus:ring-2 focus:ring-emerald-500 appearance-none cursor-pointer"
                      ...
                      <div className="shrink-0">
                          {!selectedPmeAction ? (
                              ...
                              <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-blue-100 text-blue-700 border border-blue-200 shadow-sm">
                                  PME Oficial
                              </span>
                          )}
                      </div>
